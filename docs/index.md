...
If you are upgrading to CDT version 3.0 or later from version 1.8.1 (or earlier) of [SYSIO.CDT](https://github.com/EOSIO/eosio.cdt), then please read [EOSIO.CDT to CDT](./04_upgrading/eosio.cdt-to-cdt.md).
